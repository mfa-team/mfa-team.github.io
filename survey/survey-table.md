...
<table style="color: black;">
	...
	<tr class="bank-row" id="deutsche-bank">
		...
		<td> \auth{\aA}{}{I} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_o.png"  /> \auth{\aR}{<i class="fas fa-sim-card"></i>k}{O} \chanout{\otp}{h} <br/> <i class="fas fa-table"></i> <br/> <i class="fas fa-sim-card"></i>$^{\!\!\textnormal{\scalebox{1}{{<i class="fas fa-sim-card"></i>k}}}}$ <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_o.png"  /> \auth{\aA}{<i class="fas fa-sim-card"></i>k}{O} \chanout{\otp}{h} <br/></td>
	...
	<tr class="bank-row" id="vr-bank">
		...
		<td> DE	</td>
		<td><i class="fas fa-university"></i> </td>
		<td>\auth{\aA}{}{I} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_o.png"  /> \auth{\aR}{<i class="fas fa-sim-card"></i>k}{O} \chanout{\otp}{h} <br/> \chanin{\otp}{m} <i class="fas fa-sim-card"></i>$^{\!\!\textnormal{\scalebox{1}{{<i class="fas fa-sim-card"></i>k}}}}$ \chanout{\otp}{h} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_i.png"  /> \auth{\aA}{<i class="fas fa-sim-card"></i>k}{O,K} \chanout{\otp}{i} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_n.png"  /> \auth{\aOOBS}{<i class="fas fa-sim-card"></i>k}{O,K} \chanout{\otp}{n} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_i.png"  /> \auth{\aA}{<i class="fas fa-sim-card"></i>k}{O,I} \chanout{\otp}{i} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_n.png"  /> \auth{\aOOBS}{<i class="fas fa-sim-card"></i>k}{O,I} \chanout{\otp}{n} </td>
	...
	<tr class="bank-row" id="commerzbank">
		...
		<td>DE   </td>
		<td><i class="fas fa-globe-americas"></i> </td><td> \auth{\aA}{}{I} <br/> \chanin{\opid{}}{o} \auth{\aR}{<i class="fas fa-sim-card"></i>k}{O} \chanout{\otp{}}{h} <br/> <i class="fas fa-table"></i> <br/> \chanin{\otp{}}{m} <i class="fas fa-sim-card"></i>$^{\!\!\textnormal{\scalebox{1}{{<i class="fas fa-sim-card"></i>k}}}}$ \chanout{\otp{}}{h} <br/> \chanin{\opid{}}{o} \auth{\aA}{<i class="fas fa-sim-card"></i>k}{O} \chanout{\otp{}}{h} <br/> \chanin{\opid{}}{i} \auth{\aA}{<i class="fas fa-sim-card"></i>k}{O} \chanout{\otp{}}{i} </td>
	...
	<tr class="bank-row" id="bnp-paribas">
		...
		<td>\chanin{\otp}{m} <i class="fas fa-sim-card"></i> \chanout{\otp}{h}<br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_n.png"  /> \auth{\aOOBS}{<i class="fas fa-sim-card"></i>k}{O,K} \chanout{\otp}{n} <br/> \chanin{\otp}{i} \auth{\aA}{}{O} \chanout{\otp}{i}  </td>
	...
	<tr class="bank-row" id="societe-generale">
		...
		<td>FR </td>
		<td><i class="fas fa-globe-americas"></i>   </td>
		<td>\chanin{\otp{}}{m} <i class="fas fa-sim-card"></i> \chanout{\otp}{h} <br/> \chanin{\opid{}}{i} \auth{\aA}{<i class="fas fa-sim-card"></i>k}{O,K} \chanout{\otp}{i} <br/> \chanin{\opid{}}{n} \auth{\aOOBS}{<i class="fas fa-sim-card"></i>k}{O,K} \chanout{\otp}{n}  </td>
		<td><bold>E</bold>,<i class="fas fa-globe-americas"></i>,<i class="fas fa-globe-americas"></i> <br/> <i class="fas fa-globe-americas"></i>,<i class="fas fa-globe-americas"></i>,<i class="fas fa-globe-americas"></i>(<i class="fas fa-sim-card"></i>) <br/> <i class="fas fa-globe-americas"></i>,<i class="fas fa-globe-americas"></i>,<i class="fas fa-globe-americas"></i>(<i class="fas fa-sim-card"></i>) </td>
		<td> IP-14 <br/> IP-27</td>
		<td> MP-20 </td>
		<td><i class="fas fa-check"></i></td>
	...
	<tr class="bank-row" id="unicredit">
		...
		<td>IT </td>
		<td><i class="fas fa-university"></i>   </td>
		<td>\auth{\aR}{}{O} \chanout{\otp{}}{h} <br/> <i class="fas fa-table"></i> <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_h.png"  /> \auth{\aA}{<i class="fas fa-sim-card"></i>k}{O,K} \chanout{\otp}{h} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_h.png"  /> \auth{\aA}{<i class="fas fa-sim-card"></i>k}{O,I} \chanout{\otp}{h} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_i.png"  /> \auth{\aA}{<i class="fas fa-sim-card"></i>k}{O,K} \chanout{\otp}{i} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_i.png"  /> \auth{\aA}{<i class="fas fa-sim-card"></i>k}{O,K} \chanout{\otp}{i} </td>
	...
	<tr class="bank-row" id="banco-bpm">
		...
		<td>IT </td>
		<td><i class="fas fa-university"></i>   </td>
		<td>\auth{\aR}{}{O} \chanout{\otp}{h} <br/> \auth{\aR}{}{O,K} \chanout{\otp}{h} <br/>  \auth{\aA{}}{}{O} \chanout{\otp}{h}<br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_n.png"  /> \auth{\aOOBS}{<i class="fas fa-sim-card"></i>k}{O,K} \chanout{\otp}{n} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_i.png"  /> \auth{\aA}{<i class="fas fa-sim-card"></i>k}{O,K}  \chanout{\otp}{i} </td>
	...
	<tr class="bank-row" id="bbva">
		...
		<td>ES</td>
		<td><i class="fas fa-globe-americas"></i></td>
		<td>\chanin{\otp}{m} <i class="fas fa-sim-card"></i>$^{\!\!\textnormal{\scalebox{1}{{<i class="fas fa-sim-card"></i>k}}}}$ \chanout{\otp}{h} </td>
		<td><bold>E</bold>,<i class="fas fa-globe-americas"></i>,<i class="fas fa-globe-americas"></i>  </td>
		<td>IP-15 </td>
		<td>MP-13 </td>
		<td><i class="fas fa-check"></i></td>
	...
	<tr class="bank-row" id="la-caixa">
		...
		<td>ES </td>
		<td><i class="fas fa-globe-americas"></i> </td>
		<td><i class="fas fa-table"></i> <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_n.png"  /> \auth{\aOOBS{}}{<i class="fas fa-sim-card"></i>k}{O} \chanout{\otp}{n} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_i.png"  /> \auth{\aA}{<i class="fas fa-sim-card"></i>k}{O} \chanout{\otp}{i} </td>
		<td><bold>E</bold>,<i class="fas fa-university"></i>,<i class="fas fa-university"></i> <br/> <i class="fas fa-globe-americas"></i>, <i class="fas fa-globe-americas"></i>, <img src="res/img/binding/mfa_icon.png" height="12pt" /> <br/> <i class="fas fa-globe-americas"></i>, <i class="fas fa-globe-americas"></i>, <img src="res/img/binding/mfa_icon.png" height="12pt" />  </td>
	...
	<tr class="bank-row" id="ing">
		...
		<td>NL	</td>
		<td><i class="fas fa-globe-americas"></i> </td>
		<td><i class="fas fa-table"></i> <br/> \chanin{\otp}{m} <i class="fas fa-sim-card"></i>$^{\!\!\textnormal{\scalebox{1}{{<i class="fas fa-sim-card"></i>k}}}}$ \chanout{\otp}{h} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_n.png"  />\auth{\aOOBS{}}{<i class="fas fa-sim-card"></i>k}{O,K} \chanout{\otp}{n} <br/> \auth{\aA}{}{I} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_i.png"  /> \auth{\aA{}}{<i class="fas fa-sim-card"></i>k}{O} \chanout{\otp}{i} </td>
	...
	<tr class="bank-row" id="rabobank">
		...
		<td>NL	</td>
		<td><i class="fas fa-globe-americas"></i> </td>
		<td><span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_o.png"  /> \auth{\aR}{<i class="fas fa-sim-card"></i>k}{O,K} \chanout{\otp}{h} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_h.png"  /> \auth{\aR}{<i class="fas fa-sim-card"></i>k}{O,K} \chanout{\otp}{h} <br/> \auth{\aA}{}{I}  </td>
	...
	<tr class="bank-row" id="abn-amro">
		...
		<td>NL	</td>
		<td><i class="fas fa-globe-americas"></i> </td>
		<td><span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_i.png"  /> \auth{\aR}{<i class="fas fa-sim-card"></i>k}{O,K} \chanout{\otp}{i} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_h.png"  /> \auth{\aR}{<i class="fas fa-sim-card"></i>k}{O,K} \chanout{\otp}{h} <br/> \auth{\aA}{}{I}  </td>
	...
	<tr class="bank-row" id="nordea">
		...
		<td>SW	</td>
		<td><i class="fas fa-globe-americas"></i> </td>
		<td><span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_h.png"  /> \auth{\aR}{}{O,K} \chanout{\otp}{h} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_i.png"  /> \auth{\aR}{<i class="fas fa-sim-card"></i>k}{O,K} \chanout{\otp}{i} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_i.png"  /> \auth{\aA}{<i class="fas fa-sim-card"></i>k}{O,K} \chanout{\otp}{i} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_n.png"  /> \auth{\aOOBS}{<i class="fas fa-sim-card"></i>k}{O,K} \chanout{\otp}{n}<br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_n.png"  /> \auth{\aOOBS}{<i class="fas fa-sim-card"></i>k}{O,I} \chanout{\otp}{n} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_i.png"  /> \auth{\aA}{<i class="fas fa-sim-card"></i>k}{O,K} \chanout{\otp}{i}<br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_i.png"  /> \auth{\aA}{<i class="fas fa-sim-card"></i>k}{O,I} \chanout{\otp}{i} </td>
