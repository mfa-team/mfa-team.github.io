...
<table style="color: black;">
	...
	<tr class="bank-row" id="deutsche-bank">
		...
		<td> \auth{\aA}{}{I} <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_o.png" height="16pt" /> \auth{\aR}{\ask}{O} \chanout{\otp}{h} <br/> <i class="fas fa-table"></i> <br/> \aS$^{\!\!\textnormal{\scalebox{1}{{\ask}}}}$ <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_o.png" height="16pt" /> \auth{\aA}{\ask}{O} \chanout{\otp}{h} <br/></td>
	...
	<tr class="bank-row" id="vr-bank">
		...
		<td> DE	</td>
		<td><i class="fas fa-university"></i> </td>
		<td>\auth{\aA}{}{I} <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_o.png" height="16pt" /> \auth{\aR}{\ask}{O} \chanout{\otp}{h} <br/> \chanin{\otp}{m} \aS$^{\!\!\textnormal{\scalebox{1}{{\ask}}}}$ \chanout{\otp}{h} <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_i.png" height="16pt" /> \auth{\aA}{\ask}{O,K} \chanout{\otp}{i} <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_n.png" height="16pt" /> \auth{\aOOBS}{\ask}{O,K} \chanout{\otp}{n} <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_i.png" height="16pt" /> \auth{\aA}{\ask}{O,I} \chanout{\otp}{i} <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_n.png" height="16pt" /> \auth{\aOOBS}{\ask}{O,I} \chanout{\otp}{n} </td>
	...
	<tr class="bank-row" id="lloyds-bank">
		...
		<td>UK</td>
		<td><i class="fas fa-university"></i>   </td>
		<td>\aK <br/> \chanin{\otp{}}{h} \aS{} \chanout{\otp}{m} <br/> \chanin{\opid{}}{n} \auth{\aOOBS}{}{O,K} \chanout{\otp{}}{n} <br/> \chanin{\opid{}}{n} \auth{\aOOBS}{}{O,I} \chanout{\otp{}}{n} <br/> \auth{\aA}{}{I} <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_i.png" height="16pt" /> \auth{\aA}{}{O} \chanout{otp}{i}  </td>
	...
	<tr class="bank-row" id="bnp-paribas">
		...
		<td>\chanin{\otp}{m} \aS{} \chanout{\otp}{h}<br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_n.png" height="16pt" /> \auth{\aOOBS}{\ask}{O,K} \chanout{\otp}{n} <br/> \chanin{\otp}{i} \auth{\aA}{}{O} \chanout{\otp}{i}  </td>
	...
	<tr class="bank-row" id="unicredit">
		...
		<td>IT </td>
		<td><i class="fas fa-university"></i>   </td>
		<td>\auth{\aR}{}{O} \chanout{\otp{}}{h} <br/> <i class="fas fa-table"></i> <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_h.png" height="16pt" /> \auth{\aA}{\ask}{O,K} \chanout{\otp}{h} <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_h.png" height="16pt" /> \auth{\aA}{\ask}{O,I} \chanout{\otp}{h} <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_i.png" height="16pt" /> \auth{\aA}{\ask}{O,K} \chanout{\otp}{i} <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_i.png" height="16pt" /> \auth{\aA}{\ask}{O,K} \chanout{\otp}{i} </td>
	...
	<tr class="bank-row" id="la-caixa">
		...
		<td>ES </td>
		<td><i class="fas fa-globe-americas"></i> </td>
		<td><i class="fas fa-table"></i> <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_n.png" height="16pt" /> \auth{\aOOBS{}}{\ask}{O} \chanout{\otp}{n} <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_i.png" height="16pt" /> \auth{\aA}{\ask}{O} \chanout{\otp}{i} </td>
		<td><bold>E</bold>,<i class="fas fa-university"></i>,<i class="fas fa-university"></i> <br/> <i class="fas fa-globe-americas"></i>, <i class="fas fa-globe-americas"></i>, <img src="res/img/binding/mfa_icon.png" height="12pt" /> <br/> <i class="fas fa-globe-americas"></i>, <i class="fas fa-globe-americas"></i>, <img src="res/img/binding/mfa_icon.png" height="12pt" />  </td>
	...
	<tr class="bank-row" id="ing">
		...
		<td>NL	</td>
		<td><i class="fas fa-globe-americas"></i> </td>
		<td><i class="fas fa-table"></i> <br/> \chanin{\otp}{m} \aS$^{\!\!\textnormal{\scalebox{1}{{\ask}}}}$ \chanout{\otp}{h} <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_n.png" height="16pt" />\auth{\aOOBS{}}{\ask}{O,K} \chanout{\otp}{n} <br/> \auth{\aA}{}{I} <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_i.png" height="16pt" /> \auth{\aA{}}{\ask}{O} \chanout{\otp}{i} </td>
	...
	<tr class="bank-row" id="rabobank">
		...
		<td>NL	</td>
		<td><i class="fas fa-globe-americas"></i> </td>
		<td><img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_o.png" height="16pt" /> \auth{\aR}{\ask}{O,K} \chanout{\otp}{h} <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_h.png" height="16pt" /> \auth{\aR}{\ask}{O,K} \chanout{\otp}{h} <br/> \auth{\aA}{}{I}  </td>
	...
	<tr class="bank-row" id="abn-amro">
		...
		<td>NL	</td>
		<td><i class="fas fa-globe-americas"></i> </td>
		<td><img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_i.png" height="16pt" /> \auth{\aR}{\ask}{O,K} \chanout{\otp}{i} <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_h.png" height="16pt" /> \auth{\aR}{\ask}{O,K} \chanout{\otp}{h} <br/> \auth{\aA}{}{I}  </td>
	...
	<tr class="bank-row" id="nordea">
		...
		<td>SW	</td>
		<td><i class="fas fa-globe-americas"></i> </td>
		<td><img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_h.png" height="16pt" /> \auth{\aR}{}{O,K} \chanout{\otp}{h} <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_i.png" height="16pt" /> \auth{\aR}{\ask}{O,K} \chanout{\otp}{i} <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_i.png" height="16pt" /> \auth{\aA}{\ask}{O,K} \chanout{\otp}{i} <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_n.png" height="16pt" /> \auth{\aOOBS}{\ask}{O,K} \chanout{\otp}{n}<br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_n.png" height="16pt" /> \auth{\aOOBS}{\ask}{O,I} \chanout{\otp}{n} <br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_i.png" height="16pt" /> \auth{\aA}{\ask}{O,K} \chanout{\otp}{i}<br/> <img class="authr-img" src="res/img/data_obj/opid.png" height="16pt" /><img class="authr-img" src="res/img/channels/chanin_i.png" height="16pt" /> \auth{\aA}{\ask}{O,I} \chanout{\otp}{i} </td>
