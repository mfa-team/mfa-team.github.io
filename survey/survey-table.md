...
<table style="color: black;">
	...
	<tr class="bank-row" id="commerzbank">
		...
		<td>DE   </td>
		<td><i class="fas fa-globe-americas"></i> </td><td> \aA}<span class="authr-afs">[I]</span> <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_o.png"  /> <i class="fas fa-calculator"></i><sup class="authr-info">?</sup>}<span class="authr-afs">[O]</span> \chanout{\otp{}h} <br/> <i class="fas fa-table"></i> <br/> \chanin{\otp{}m} <i class="fas fa-sim-card"></i><sup class="authr-info">?</sup> \chanout{\otp{}h} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_o.png"  /> \aA<sup class="authr-info">?</sup>}<span class="authr-afs">[O]</span> \chanout{\otp{}h} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_o.png"  /> \aA<sup class="authr-info">?</sup>}<span class="authr-afs">[O]</span> \chanout{\otp{}i} </td>
	...
	<tr class="bank-row" id="hsbc">
		...
		<td>UK	</td>
		<td><i class="fas fa-university"></i>  </td>
		<td><i class="fas fa-calculator"></i>}<span class="authr-afs">[O,K]</span> \chanout{\otp{}h} <br/> \aA}<span class="authr-afs">[O,K]</span> \chanout{\otp{}h} <br/> \aA}<span class="authr-afs">[O,I]</span> \chanout{\otp{}h} <br/> \aA}<span class="authr-afs">[O,K]</span> \chanout{\otp{}i} <br/> \aA}<span class="authr-afs">[O,I]</span> \chanout{\otp{}i} </td>
	...
	<tr class="bank-row" id="barclays">
		...
		<td>UK	</td>
		<td> <i class="fas fa-university"></i>  </td>
		<td>\aK <br/> <i class="fas fa-calculator"></i>}<span class="authr-afs">[O,K]</span> \chanout{\otp{}h} <br/> \aA}<span class="authr-afs">[O,K]</span> \chanout{\otp{}h} <br/> \aA}<span class="authr-afs">[O,I]</span> \chanout{\otp{}h}  </td>
	...
	<tr class="bank-row" id="lloyds-bank">
		...
		<td>UK</td>
		<td><i class="fas fa-university"></i>   </td>
		<td>\aK <br/> \chanin{\otp{}h} <i class="fas fa-sim-card"></i> \chanout{\otpm} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_n.png"  /> \aOOBS}<span class="authr-afs">[O,K]</span> \chanout{\otp{}n} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_n.png"  /> \aOOBS}<span class="authr-afs">[O,I]</span> \chanout{\otp{}n} <br/> \aA}<span class="authr-afs">[I]</span> <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_i.png"  /> \aA}<span class="authr-afs">[O]</span> \chanout{otpi}  </td>
	...
	<tr class="bank-row" id="societe-generale">
		...
		<td>FR </td>
		<td><i class="fas fa-globe-americas"></i>   </td>
		<td>\chanin{\otp{}m} <i class="fas fa-sim-card"></i> <img class="authr-img channel" src="res/img/channels/chanout_h.png"  /><span class="authr-data-obj">otp</span> <br/> \chanin{\opid{}i} \aA<sup class="authr-info">?</sup>}<span class="authr-afs">[O,K]</span> <img class="authr-img channel" src="res/img/channels/chanout_i.png"  /><span class="authr-data-obj">otp</span> <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_n.png"  /> \aOOBS<sup class="authr-info">?</sup>}<span class="authr-afs">[O,K]</span> <img class="authr-img channel" src="res/img/channels/chanout_n.png"  /><span class="authr-data-obj">otp</span>  </td>
		<td><bold>E</bold>,<i class="fas fa-globe-americas"></i>,<i class="fas fa-globe-americas"></i> <br/> <i class="fas fa-globe-americas"></i>,<i class="fas fa-globe-americas"></i>,<i class="fas fa-globe-americas"></i>(<i class="fas fa-sim-card"></i>) <br/> <i class="fas fa-globe-americas"></i>,<i class="fas fa-globe-americas"></i>,<i class="fas fa-globe-americas"></i>(<i class="fas fa-sim-card"></i>) </td>
		<td> IP-14 <br/> IP-27</td>
		<td> MP-20 </td>
		<td><i class="fas fa-check"></i></td>
	...
	<tr class="bank-row" id="unicredit">
		...
		<td>IT </td>
		<td><i class="fas fa-university"></i>   </td>
		<td><i class="fas fa-calculator"></i>}<span class="authr-afs">[O]</span> \chanout{\otp{}h} <br/> <i class="fas fa-table"></i> <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_h.png"  /> \aA<sup class="authr-info">?</sup>}<span class="authr-afs">[O,K]</span> <img class="authr-img channel" src="res/img/channels/chanout_h.png"  /><span class="authr-data-obj">otp</span> <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_h.png"  /> \aA<sup class="authr-info">?</sup>}<span class="authr-afs">[O,I]</span> <img class="authr-img channel" src="res/img/channels/chanout_h.png"  /><span class="authr-data-obj">otp</span> <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_i.png"  /> \aA<sup class="authr-info">?</sup>}<span class="authr-afs">[O,K]</span> <img class="authr-img channel" src="res/img/channels/chanout_i.png"  /><span class="authr-data-obj">otp</span> <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_i.png"  /> \aA<sup class="authr-info">?</sup>}<span class="authr-afs">[O,K]</span> <img class="authr-img channel" src="res/img/channels/chanout_i.png"  /><span class="authr-data-obj">otp</span> </td>
	...
	<tr class="bank-row" id="banca-intesa">
		...
		<td>IT </td>
		<td><i class="fas fa-university"></i>   </td>
		<td><i class="fas fa-calculator"></i>}<span class="authr-afs">[O]</span> \chanout{\otp{}h} <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_n.png"  /> \aOOBS<sup class="authr-info">?</sup>}<span class="authr-afs">[O,K]</span> <img class="authr-img channel" src="res/img/channels/chanout_n.png"  /><span class="authr-data-obj">otp</span><br/>  <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_n.png"  /> \aOOBS<sup class="authr-info">?</sup>}<span class="authr-afs">[O,I]</span> <img class="authr-img channel" src="res/img/channels/chanout_n.png"  /><span class="authr-data-obj">otp</span> <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_i.png"  /> \aA<sup class="authr-info">?</sup>}<span class="authr-afs">[O,K]</span> <img class="authr-img channel" src="res/img/channels/chanout_i.png"  /><span class="authr-data-obj">otp</span> <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_i.png"  /> \aA<sup class="authr-info">?</sup>}<span class="authr-afs">[O,I]</span> <img class="authr-img channel" src="res/img/channels/chanout_i.png"  /><span class="authr-data-obj">otp</span>  </td>
	...
	<tr class="bank-row" id="la-caixa">
		...
		<td>ES </td>
		<td><i class="fas fa-globe-americas"></i> </td>
		<td><i class="fas fa-table"></i> <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_n.png"  /> \aOOBS{}<sup class="authr-info">?</sup>}<span class="authr-afs">[O]</span> <img class="authr-img channel" src="res/img/channels/chanout_n.png"  /><span class="authr-data-obj">otp</span> <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_i.png"  /> \aA<sup class="authr-info">?</sup>}<span class="authr-afs">[O]</span> <img class="authr-img channel" src="res/img/channels/chanout_i.png"  /><span class="authr-data-obj">otp</span> </td>
		<td><bold>E</bold>,<i class="fas fa-university"></i>,<i class="fas fa-university"></i> <br/> <i class="fas fa-globe-americas"></i>, <i class="fas fa-globe-americas"></i>, <img src="res/img/binding/mfa_icon.png" height="12pt" /> <br/> <i class="fas fa-globe-americas"></i>, <i class="fas fa-globe-americas"></i>, <img src="res/img/binding/mfa_icon.png" height="12pt" />  </td>
	...
	<tr class="bank-row" id="ing">
		...
		<td>NL	</td>
		<td><i class="fas fa-globe-americas"></i> </td>
		<td><i class="fas fa-table"></i> <br/> <span class="authr-data-obj">otp</span><img class="authr-img channel" src="res/img/channels/chanin_m.png"  /> <i class="fas fa-sim-card"></i><sup class="authr-info">?</sup> <img class="authr-img channel" src="res/img/channels/chanout_h.png"  /><span class="authr-data-obj">otp</span> <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_n.png"  />\aOOBS{}<sup class="authr-info">?</sup>}<span class="authr-afs">[O,K]</span> <img class="authr-img channel" src="res/img/channels/chanout_n.png"  /><span class="authr-data-obj">otp</span> <br/> \aA}<span class="authr-afs">[I]</span> <br/> <span class="authr-data-obj">opid</span><img class="authr-img channel" src="res/img/channels/chanin_i.png"  /> \aA{}<sup class="authr-info">?</sup>}<span class="authr-afs">[O]</span> <img class="authr-img channel" src="res/img/channels/chanout_i.png"  /><span class="authr-data-obj">otp</span> </td>
